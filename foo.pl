...
############################################################
#
#   $Id: SendSMS.pl 968 2007-03-03 22:04:15Z nicolaw $
...
our $VERSION = sprintf('%d.%02d', q$Revision: 968.0 $ =~ /(\d+)/g);
...
my $rtn = SendSMS($soapCfg,{
	         'Client_ID'    => 'AU0621955',     # (str) Provided by TextAnywhere
                'Client_Pass'  => 'toOl!uses',     # (str) Provided by TextAnywhere
