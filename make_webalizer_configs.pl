...
chdir '/home/nicolaw/webroot/apache-2.2.0';
my $cnf = Config::General->new(
				-ConfigFile => 'conf/nw.httpd.conf',
				-AllowMultiOptions => 1,
				-UseApacheInclude => 1,
...
my %config = $cnf->getall;
my $TEMPLATE = join('',<DATA>);

while (my (undef,$vhost) = each %{$config{VirtualHost}}) {
	#next unless $vhost->{ServerName} =~ /^bb/;
	print "Processing $vhost->{ServerName} ";

	my %data = (
			HostName => $vhost->{ServerName},
			OutputDir => "$vhost->{DocumentRoot}/webalizer/current",
			LogGlob => "$config{ServerRoot}/logs/$vhost->{ServerName}/access.log*",
			LogFile => "$config{ServerRoot}/logs/$vhost->{ServerName}/access.log",
		);
	$data{$vhost->{ServerName}}->{ServerAlias} = defined $vhost->{ServerAlias}
								? [split(/\s+/,$vhost->{ServerAlias})] : [];
	...
	my $config_file = "/home/nicolaw/webroot/webalizer/etc/$vhost->{ServerName}.conf";
	open(FH,'>',$config_file) || die "Unable to open file '$config_file': $!";
	print FH $CONFIG;
	close(FH) || warn "Unable to close file '$config_file': $!";

	if (!-d $data{OutputDir}) {
		mkpath([($data{OutputDir})]);
	}

	my @log_files = sort(grep(/-\d{8}\.gz$/,glob($data{LogGlob})));
	push @log_files, $data{LogFile};
	for my $gzlogfile (@log_files) {
		print ".";
		(my $logfile = $gzlogfile) =~ s/\.gz$//;
		if ($gzlogfile =~ /\.gz$/) {
			system("zcat $gzlogfile > $logfile");
		}
		#my $cmd = sprintf('/home/nicolaw/webroot/webalizer/bin/webalizer '.
		my $cmd = sprintf('/usr/bin/webalizer  -F clf -f -p -q -c %s %s',
						$config_file, $logfile);
		#print "$cmd\n";
		system($cmd);
		unlink $logfile if $gzlogfile =~ /\.gz$/ && $gzlogfile ne $logfile;
	}
...
DNSCache	/home/nicolaw/etc/dns_cache.db
...
#HTMLPre <!--#exec cgi="/cgi-local/header.cgi" -->
HTMLPre <!-- HTMLPre -->
...
HTMLEnd <!-- HTMLEnd -->
#HTMLEnd <!--#exec cgi="/cgi-local/footer.cgi" -->
#HTMLEnd </BODY></HTML>
...
HideReferrer	@@HostName@@
HideReferrer	@@HostName@@/
#HideReferrer	83.138.190.120/
...
GroupReferrer	freshmeat.net/	www.freshmeat.net
HideReferrer	freshmeat.net/

GroupReferrer	nicolaworthington.com/	www.nicolaworthington.com
HideReferrer	nicolaworthington.com/

GroupReferrer	nicolaelizabeth.com/	www.nicolaworthington.com
HideReferrer	nicolaelizabeth.com/

GroupReferrer	yahoo.com/	Yahoo!
GroupReferrer	yahoo.co.uk/	Yahoo!

HideReferrer	yahoo.com/
HideReferrer	yahoo.co.uk/

GroupReferrer	excite.com/     Excite
GroupReferrer	infoseek.com/   InfoSeek
GroupReferrer	webcrawler.com/ WebCrawler

HideReferrer	excite.com/
HideReferrer	infoseek.com/
HideReferrer	webcrawler.com/

GroupReferrer	msn.co.uk/	MSN
GroupReferrer	msn.com/	MSN

HideReferrer	msn.co.uk/
HideReferrer	msn.com/

GroupReferrer	google.se/	Google
GroupReferrer	google.es/	Google
GroupReferrer	google.no/	Google
GroupReferrer	google.ae/	Google
GroupReferrer	google.at/	Google
GroupReferrer	google.be/	Google
GroupReferrer	google.ca/	Google
GroupReferrer	google.ch/	Google
GroupReferrer	google.cl/	Google
GroupReferrer	google.co.in/	Google
GroupReferrer	google.co.hu/	Google
GroupReferrer	google.co.il/	Google
GroupReferrer	google.co.jp/	Google
GroupReferrer	google.co.kr/	Google
GroupReferrer	google.co.nz/	Google
GroupReferrer	google.co.th/	Google
GroupReferrer	google.co.uk/	Google
GroupReferrer	google.co.ve/	Google
GroupReferrer	google.com.ar/	Google
GroupReferrer	google.com.au/	Google
GroupReferrer	google.com.br/	Google
GroupReferrer	google.com.gm/	Google
GroupReferrer	google.com.gr/	Google
GroupReferrer	google.com.hk/	Google
GroupReferrer	google.com.mt/	Google
GroupReferrer	google.com.mu/	Google
GroupReferrer	google.com.mx/	Google
GroupReferrer	google.com.pe/	Google
GroupReferrer	google.com.pr/	Google
GroupReferrer	google.com.ru/	Google
GroupReferrer	google.com.sg/	Google
GroupReferrer	google.com.tr/	Google
GroupReferrer	google.com.tw/	Google
GroupReferrer	google.com.ua/	Google
GroupReferrer	google.com/	Google
GroupReferrer	google.de/	Google
GroupReferrer	google.fi/	Google
GroupReferrer	google.fr/	Google
GroupReferrer	google.ie/	Google
GroupReferrer	google.it/	Google
GroupReferrer	google.lt/	Google
GroupReferrer	google.nl/	Google
GroupReferrer	google.pl/	Google
GroupReferrer	google.pt/	Google

HideReferrer	google.se/
HideReferrer	google.es/
HideReferrer	google.no/
HideReferrer	google.ae/
HideReferrer	google.at/
HideReferrer	google.be/
HideReferrer	google.ca/
HideReferrer	google.ch/
HideReferrer	google.cl/
HideReferrer	google.co.in/
HideReferrer	google.co.hu/
HideReferrer	google.co.il/
HideReferrer	google.co.jp/
HideReferrer	google.co.kr/
HideReferrer	google.co.nz/
HideReferrer	google.co.th/
HideReferrer	google.co.uk/
HideReferrer	google.co.ve/
HideReferrer	google.com.ar/
HideReferrer	google.com.au/
HideReferrer	google.com.br/
HideReferrer	google.com.gm/
HideReferrer	google.com.gr/
HideReferrer	google.com.hk/
HideReferrer	google.com.mt/
HideReferrer	google.com.mu/
HideReferrer	google.com.mx/
HideReferrer	google.com.pe/
HideReferrer	google.com.pr/
HideReferrer	google.com.ru/
HideReferrer	google.com.sg/
HideReferrer	google.com.tr/
HideReferrer	google.com.tw/
HideReferrer	google.com.ua/
HideReferrer	google.com/
HideReferrer	google.de/
HideReferrer	google.fi/
HideReferrer	google.fr/
HideReferrer	google.ie/
HideReferrer	google.it/
HideReferrer	google.lt/
HideReferrer	google.nl/
HideReferrer	google.pl/
HideReferrer	google.pt/
...
IgnoreSite	85.158.42.201
IgnoreSite	85.158.42.202
IgnoreSite	85.158.42.203
IgnoreSite	85.158.42.204
IgnoreSite	85.158.42.205
IgnoreSite	85.158.42.206
IgnoreSite	85.158.42.207

#IgnoreSite	jessica.2x4b.com
#IgnoreSite	lutn-cache-2.server.ntli.net
#IgnoreSite	nicolaelizabeth.com

#IgnoreSite	*.mh.bbc.co.uk
#IgnoreSite	*.thls.bbc.co.uk

IgnoreSite	81.168.3.168
IgnoreSite	81.168.3.169
IgnoreSite	81.168.3.170
IgnoreSite	81.168.3.171
IgnoreSite	81.168.3.172
IgnoreSite	81.168.3.173
IgnoreSite	81.168.3.174
IgnoreSite	81.168.3.175
IgnoreSite	212.100.249.246
IgnoreSite	83.138.190.120 
IgnoreSite	83.138.190.121 
IgnoreSite	83.138.190.122 
IgnoreSite	83.138.190.123 
IgnoreSite	83.138.190.124 
IgnoreSite	83.138.190.125 
IgnoreSite	83.138.190.126 
IgnoreSite	83.138.190.127 
